...
getContractFactory(name: 'AccredRegistry', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.AccredRegistry__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'AccredRegistry', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.AccredRegistry>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'AccredRegistry', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.AccredRegistry>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'AccredRegistry', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.AccredRegistry>
